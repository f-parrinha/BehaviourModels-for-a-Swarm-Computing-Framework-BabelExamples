...
import abp.common.utils.LogUtils;
import abp.handlers.*;
...
@Typestate("AlternatingBitProtocol")
public class AlternatingBitProtocol extends GenericProtocol {
    ...
    public void uponBitSend(BitSend message, Host sender, short sourceProto, int channelId) {
    ...
    public void uponBitAck(BitAck message, Host sender, short sourceProto, int channelId) {
        LogUtils.ReceivedMessage(logger, myself, sender, message);
    ...
    public void uponBitTimer(BitTimer timer, long timerId) {
