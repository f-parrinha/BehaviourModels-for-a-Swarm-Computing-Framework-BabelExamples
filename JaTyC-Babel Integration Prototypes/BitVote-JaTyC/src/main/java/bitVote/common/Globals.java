...
public class Globals {
    ...
    public static final int CONNECTION_RETRY_WAIT = 2000;


    /* MESSAGES */
    public static final String RECEIVED_MESSAGE = "({}) Received message from '{}: {}'";
    public static final String SENDING_MESSAGE = "({}) Sending message to '{}: {}'";

    /* ERROR LOGS */
    public static final String WRONG_CLASS_FOR_HANDLER_MSG = "Wrong class type for this handler";
    public static final String WRONG_CLASS_FOR_SERIALIZER_MSG = "Wrong class type for this serializer";
