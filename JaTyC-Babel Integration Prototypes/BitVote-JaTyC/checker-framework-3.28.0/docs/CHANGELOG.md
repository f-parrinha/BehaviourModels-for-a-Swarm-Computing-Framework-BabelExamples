...
`JavaExpressionParseUtil#parse` no longer takes a appContext object.  Most calls to
...
User-visible framework improvements:
  ...
  Type-checking improvements:
    ...
    Better handling of assignment appContext and improved inference of
...
Internal framework improvements:
  ...
  Assignment appContext is now a type, not a tree.
