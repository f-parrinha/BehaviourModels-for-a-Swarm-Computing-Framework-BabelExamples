...
public class SetAckMessageSerializer<T> implements ISerializer<T> {
    private static final Logger logger = nonNull(LogManager.getLogger(SetAckMessageSerializer.class));
    ...
    public void serialize(T t, ByteBuf byteBuf) throws IOException {
        ...
        var setMessage = (SetAckMessage) t;
    ...
    public T deserialize(ByteBuf byteBuf) {
        ...
        return (T) new SetAckMessage(set);
    }
}
