...
public class SetRecoveryMessageSerializer <T> implements ISerializer<T> {
    private static final Logger logger = nonNull(LogManager.getLogger(SetRecoveryMessageSerializer.class));
    ...
    public void serialize(T t, ByteBuf byteBuf) throws IOException {
        ...
        var setMessage = (SetRecoveryMessage) t;
    ...
    public T deserialize(ByteBuf byteBuf) throws IOException {
        ...
        return (T) new SetRecoveryMessage(set);
    }
}
